...
gg = ggplot(data =variancedf, aes(x=variance)) + geom_histogram(binwidth=10, colour="black", aes(y=..density.., fill=..count..))
gg = gg + scale_fill_gradient("Count", low="#DCDCDC", high="#7C7C7C")
...
gg = ggplot(data =skewdf, aes(x=skew)) + geom_histogram(binwidth=0.1, colour="black", aes(y=..density.., fill=..count..))
gg = gg + scale_fill_gradient("Count", low="#DCDCDC", high="#7C7C7C")
...
gg = ggplot(data =kurtodf, aes(x=kurto)) + geom_histogram(binwidth=0.2, colour="black", aes(y=..density.., fill=..count..))
gg = gg + scale_fill_gradient("Count", low="#DCDCDC", high="#7C7C7C")
...
for(i in listEnterprise[1:7]){
  ...
  adjusted = Ad(a)
  return = exp(diff(log(adjusted))) - 1
  moyenne2 <- c(moyenne,mean(return))
  variance2 <- c(variance,sqrt(var(return)))
  skew2 <- c(skew, skewness(return))
  kurto2 <- c(kurto, kurtosis(return))
}
moyenne2 = na.omit(moyenne2)
variance2 = na.omit(variance2)
skew2 = na.omit(skew2)
kurto2 = na.omit(kurto2)
SP500Matrix2 <- c(moyenne2, variance2, skew2, kurto2)
SP500Matrix2 <- matrix(SP500Matrix2, byrow=TRUE, nrow = 4)
```
...
for(i in listEnterprise){
  ...
  adjusted = Ad(a)
  moyenne4 <- c(moyenne4,mean(adjusted))
  variance4 <- c(variance4,sqrt(var(adjusted)))
  skew4 <- c(skew4, skewness(adjusted))
  kurto4 <- c(kurto4, kurtosis(adjusted))
}
